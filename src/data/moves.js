...
export const projectShowcaseProjects = [
  ...
  {
    id: "secl-internship",
    title: "SECL Internship Management System",
    host: "GitHub repository",
    summary:
      "A centralized web application built to digitize and streamline internship management workflows.",
    description:
      "I developed this system during my internship to replace manual processes with a centralized platform for applications, department allocation, mentor tracking, attendance, and admin analytics.",
    tech: ["React", "Spring Boot", "MySQL", "Internship Project"],
    githubUrl: "https://github.com/samarthratnam/SECL-Internship-Management-System.git",
    vercelUrl: null,
    imageUrl: "/project-showcase/seclims.png",
    imageAlt: "SECL Internship Management System cover photo",
  },
  {
    id: "animanga",
    title: "Animanga",
...
export const sectionMilestones = [
  ...
  },
  {
    ...
    skillGroups: [
      ...
      {
        title: "🗄️ Databases",
        items: ["MySQL", "SQLite", "Database Design"],
      },
      {
        ...
        items: [
          ...
          "Git",
          "GitHub",
          "GitHub Actions (if you add CI/CD later)",
          "Vercel",
          "Netlify",
        ],
      },
...
},
{
  ...
  issuer: "Agentic AI",
  summary:
    "Completed an AI bootcamp focused on agentic systems, autonomous workflows, and modern AI product design.",
  imageUrl: "/certificates/agenticaibootcamp.png",
  url: null,
},
{
  id: "nptel-aiml",
...
},
{
  ...
  },
  {
    ...
    body: ["Software Development Internn",
            ...
            "Participant – Agentic AI Boot Camp",
            "KLGLUG (KL GNU/Linux Users Group)",
            "Participated in a 24-hour Agentic AI Boot Camp hosted by KLGLUG at KL University. Explored the fundamentals of agentic AI systems, modern AI workflows, prompt engineering, autonomous agents, and real-world AI applications through hands-on sessions and collaborative activities. The boot camp strengthened my understanding of AI-driven software development and inspired me to further explore intelligent automation and agent-based systems.",
    ],
  },
  {
    id: "education",
